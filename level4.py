...
from gameObjects import Tile, Player, GruntTile, PrisionTile, Plane, BossOhm, MiniGrizzlyBear, LavaTile
    ...
    def create_map(self):
        for row_index, row in enumerate(WORLD_MAP4):
            for col_index, col in enumerate(row):
                ...
                if col == "t" or col == "p" or col =="g" or col == "b" or col == "o" or col == "a":
        ...
        for row_index, row in enumerate(WORLD_MAP4):
            for col_index, col in enumerate(row):
                ...
                if col == " ":
                    LavaTile((x, y), [self.visible_sprites, self.obstacle_sprites])
                ...
                if col == "b":
                    MiniGrizzlyBear((x, y), [self.visible_sprites,
                                       self.miniBoss_sprite])
                
                if col == "o":
                    BossOhm((x, y), [self.visible_sprites,
                                       self.boss_sprite])
                    
                if col == "a":
                    Plane((x, y), [self.visible_sprites,
                                       self.plane_sprite])
